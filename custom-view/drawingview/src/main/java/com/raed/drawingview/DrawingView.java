...
public class DrawingView extends View {
    ...
    public Bitmap exportDrawingWithBackground() {
        Bitmap bitmap = Bitmap.createBitmap(
                mDrawingBitmap.getWidth(),
                mDrawingBitmap.getHeight(),
                Bitmap.Config.ARGB_8888);
    ...
    public Bitmap exportBackgroundBitmap() {
        return mBGBitmap;
    }
    ...
    private void initializeAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            int brushColor = typedArray.getColor(R.styleable.DrawingView_brush_color, 0x0000000);
